...
You can call the simulator using `pk2sim!` and the function modifies the input vector `y`.
...
You can call the simulator using `pk3sim!` and the function modifies the input vector `y`.
For speedup, use `Float32` values for your inputs.
